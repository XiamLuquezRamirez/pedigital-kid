...
function controlarRespuesta(opcionElegida) {
    ...
    if (respuesta == opcionElegida.innerHTML) {
        ...
        document.getElementById("preg_" + preg).innerHTML =
            "<i style='color: green' class='fa-sharp fa-solid fa-face-smile fa-2x'></i>";
        ...
        setTimeout(comenzar, 1500);
        document.getElementById("preg_" + preg).innerHTML =
            "<i style='color: red' class='fa-solid fa-face-sad-tear fa-2x'></i>";
