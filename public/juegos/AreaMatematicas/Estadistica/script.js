...
function generarTabla(datos) {
  ...
  frecuencias.forEach(function(dato) {
      celda += "<tr>"+
          ...
          "<td><input type='text' data-id='" + dato.frecuenciaRelativa.toFixed(2) + "' class='valor'></td>"+
          "<td><input type='text' data-id='" + dato.frecuenciaRelativaAcumulada.toFixed(2) + "' class='valor'></td>"+
          "<td><input type='text' data-id='" + dato.porcentaje.toFixed(2) + "' class='valor'> %</td>"+
      "</tr>";
  });
...
function medidasTendenciaCentral(datos) {
    ...
    document.getElementById("moda").setAttribute("data-id", modaValores.join(", "));
}
