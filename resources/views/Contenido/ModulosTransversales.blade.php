...
@section('title', 'Módulos Transversales')
@section('Contenido')
    ...
    <div class="container-fluid bg-primary block-padding pattern2 pt-lg-0">
        ...
        <!-- image  -->
        <div class="container">
            <div class="carousel-3items owl-carousel owl-theme col-lg-12 pb-3">
                <!-- service 1  -->
                ...
                @foreach ($Asignaturas as $Modu)
                    <div class="serviceBox2">
                            ...
                            @foreach ($imgmodulo as $img)
                                @if ($active == '1')
                                    ...
                                    @if ($Modu->id == $img->modulo_img)
                                        ...
                                        <a href="#">
                                            <img src="{{ Session::get('URL') . '/app-assets/images/Img_GradosModTransv/' . $img->url_img }}"
                                                alt="" class="blob img-fluid">
                                        </a>
                                        @php
                                            $active = '2';
                                        @endphp
                        ...
                        <div class="service-content">
                            ...
                            <!-- Button -->
                            <a href="{{ url('/Contenido/PresentacionContMod/' . $Modu->id . '/' . $Est) }}"
                                class="btn btn-quaternary  btn-sm mt-2 ml-1">Entrar</a>
                        </div>
                    </div>
