...
@section('title', 'Desarrollo de Actividades y Evaluaciones')
@section('Contenido')
    ...
    <div class="container-fluid block-padding" style="padding-top: 40px; ">
        <div class="container block-padding ">
            <div class="row ">
                <h3 class="text-center mb-0">{{ $Temas->titu_contenido }}</h3>
            </div>

            <div class="widget-area notepad pt-1">
                <h5 class="sidebar-header">{{ $Clasif }}</h5>
                <div class="list-group" id="Div_ListEva">
                    @foreach ($Eval as $Eva)
                        <a href='javascript:void(0)' style="text-transform: capitalize;" data-idfila='{{ $Eva->id }}'
                            id="eval{{ $Eva->id }}" class="list-group-item list-group-item-action btn_eva"><i
                                class="flaticon-pencils"></i>
                            {{ $Eva->titulo }}
                        </a>
                    @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="contact-info col-lg-12">
                                ...
                                <button type="button" onclick="$.MostListEval();" id="Btn_Produc"
                                    class="btn-margin btn btn-quaternary ml-1"><i class="fa fa-angle-double-left"></i>
                                    Atras</button>
                ...
                <a class="custom-link float-right mt-5" id="back-eval" href="javascript:history.go(-1)">Atras</a>
                <!-- /list-group -->
            </div>
        </div>
    </div>
    ...
    {!! Form::open(['url' => '/Guardar/RespEvalDida', 'id' => 'formGuarEvalDida']) !!}
    {!! Form::close() !!}
    ...
    <script>
        $(document).ready(function() {
            ...
            $.extend({
                ...
                hab_ediEnsayo: function() {
                    CKEDITOR.replace('summernoteEnsayo', {
                        width: '100%',
                        height: 250
                    });
                },
