...
<input type="hidden" class="form-control" id="RutContDid" data-ruta="{{ Session::get('URL') }}/app-assets/Contenido_Didactico"/>
...
<div class="container-fluid block-padding" style="padding-top: 40px; ">
    <div class="container block-padding ">
        ...
        <div class="widget-area notepad">
            ...
            <a class="custom-link float-right mt-5" id="Btn_AtraTema" href="{{url('/Contenido/VerTemas/'.Session::get('IDTEMA'))}}">Atras</a>
