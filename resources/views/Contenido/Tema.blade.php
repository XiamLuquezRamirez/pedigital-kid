            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-2" style="text-align: left;padding-top: 25px;">
                        @if ($Animac == 's')
                            <!--                    <ul class="social-list float-left list-inline">
                                                <li class="list-inline-item"><a  title="Animaciones" href="{{ asset('/Animaciones/VerAnimaciones/' . $Temas->id) }}"><i class="fa fa-video"></i></a></li>
                                            </ul>-->

                            <a href="{{ asset('/Animaciones/VerAnimaciones/' . $Temas->id) }}"><img
                                    src="{{ asset('img/ornaments/animacion1.png') }}" style="height: 90px; width: 70px;"
                                    class="floating-whale2" alt=""></a>
                    ...
                    <div class="col-lg-10" style="text-align: right;padding-top: 25px;">
                        ...
                        @if ($ActIni == 's')
                            <button type="button" data-ruta="{{ asset('/Evaluaciones/ActEval/' . $Temas->id . '/ACTINI') }}"
                                onclick="$.MostActEval(this.id);" id="Btn_ActIni" class="btn btn-tertiary"> <i
                                    class="flaticon-teacher"></i> Actividad de Inicio</button>
                        @endif
                        @if ($Produc == 's')
                            <button type="button" data-ruta="{{ asset('/Evaluaciones/ActEval/' . $Temas->id . '/PRODUC') }}"
                                onclick="$.MostActEval(this.id);" id="Btn_Produc"
                                class="btn-margin btn btn-quaternary ml-1"> <i class="flaticon-teacher"></i>
                                Producción</button>
                        @endif
                    </div>
                </div>
