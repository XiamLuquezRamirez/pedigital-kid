...
class RespGrupPreg extends Model {
    ...
    public static function DesRespGrupPrg($DesEva) {
        ...
        return RespGrupPreg::join('evaluacion', 'evaluacion.id', 'resp_grupregunta.evaluacion')
                        ...
                        ->select('resp_grupregunta.id', 'resp_grupregunta.evaluacion', 'resp_grupregunta.fecha', 'resp_grupregunta.respuesta', 'eval_grupregunta.puntuacion', 'eval_grupregunta.pregunta', 'evaluacion.intentos_perm', 'evaluacion.calif_usando', 'evaluacion.punt_max', 'evaluacion.titulo', 'evaluacion.tip_evaluacion', 'alumnos.nombre_alumno', 'alumnos.apellido_alumno', 'resp_grupregunta.punt_obtenida')
